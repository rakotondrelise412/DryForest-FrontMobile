// app/reboisement/auto-generation.tsx
...
import { styles } from "@/assets/css/plantation-monitoring.styles";

export const options = {
  title: "Auto-Génération",
};

export default function AutoGenerationScreen() {
  ...
  const [autoGenerationCount, setAutoGenerationCount] = useState("");
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          <Text style={styles.title}>Formulaire d{"'"}Auto-Génération</Text>
          ...
          {/* Nombre d'auto-génération */}
          <View style={styles.inputContainer}>
            <Text style={styles.label}>Nombre d{"'"}auto-génération</Text>
            <TextInput
              style={styles.textInput}
              value={autoGenerationCount}
              onChangeText={setAutoGenerationCount}
              onFocus={() => handleInputFocus('autoGeneration')}
              onBlur={handleInputBlur}
              keyboardType="numeric"
              placeholder="Entrez le nombre d'auto-génération"
              placeholderTextColor="#FFFFFFAA"
            />
          </View>
