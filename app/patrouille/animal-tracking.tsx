...
import { styles } from "../../assets/css/animal-tracking-patrouille.styles";
...
export default function AnimalTrackingScreen() {
  ...
  const updateAnimalLine = (
    id: string,
    field: keyof AnimalLine,
    value: string | boolean,
  ) => {
    setAnimalLines(
      animalLines.map((line) =>
              ...
              <View key={line.id} style={styles.animalLine}>
                <View style={[styles.animalInputContainer, { flex: 3 }]}>
                  <AnimalPicker
                    ...
                    onValueChange={(value) =>
                      updateAnimalLine(line.id, "animal", value)
                    }
                  />
                </View>
                ...
                >
                  ...
                  <TouchableOpacity
                    style={[
                      styles.checkbox,
                      line.hasSeen && styles.checkboxChecked,
                    ]}
                    onPress={() =>
                      updateAnimalLine(line.id, "hasSeen", !line.hasSeen)
                    }
                  >
